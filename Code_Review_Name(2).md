Project name: Multiple Choice Math
Programmers: Parker, Moath, Mohammed
Code Reviewer: Dillon
...
Specifically: The ServerGUI program produced a NullPointerException when I tried to start the server.
